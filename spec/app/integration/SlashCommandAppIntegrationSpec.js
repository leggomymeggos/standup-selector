...
describe('SlashCommandApp Integration Test', () => {
    ...
    beforeEach(() => {
        ...
        let standupperSheetData = [
            ...
            ['standupPerson3', 'standupper3@email.com', '10/29/2018', '', 'Y', '', 'dmUcid3'],
            ['standupPerson4', 'standupper4@email.com', '11/19/2018', '3', '', 'Y', 'dmUcid4']
        ];
    ...
    describe('a help command is sent', () => {
        it('should return a help response', () => {
            const helpRequest = JSON.parse(fs.readFileSync('spec/app/integration/slashCommandApp/helpRequest.json', 'utf8'));
            const response = HandleRequest(helpRequest);
            const expectedResponse = JSON.parse(fs.readFileSync('spec/app/integration/slashCommandApp/helpResponse.json', 'utf8'));
    ...
    describe('a reject command is sent', () => {
        it('should reject the person specified', () => {
            const rejectCallback = JSON.parse(fs.readFileSync('spec/app/integration/slashCommandApp/rejectRequest.json', 'utf8'));

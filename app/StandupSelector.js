...
function selectStanduppers() {
  ...
  var newStateRow = [
     ...
     "not-confirmed",
     "not-confirmed",
     selectedStanduppers.map(function(e){return e.slackName}).join(', '),
     '',
     standupIssuanceUuid
  ];
...
//      }, standuppers[0].getNumTimesSelected());
      ...
      var maxTimesSelected = Math.max.apply(Math, standuppers.map(function(su){return su.getNumTimesSelected();}));
